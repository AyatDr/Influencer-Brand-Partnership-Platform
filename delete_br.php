...
session_start();
    ...
    //le code récupère l'ID de l'utilisateur à partir de la variable de session et l'insère dans une table appelée demande_suppression_br en utilisant une requête préparée
   $user_id=$_SESSION['user_id'];
   $requser = $connection->prepare('INSERT  into demande_suppression_br(id_br)  VALUES (?)');
...
<html>
    ...
    <ul>     <!--liste de lien -->
            ...
            <a  href="logout.php"><li><i class="fa-solid fa-key" style="color: #ffffff;"></i><span class="titre ">Log out</span></li></a> <br>
     </ul>         
    </div>
