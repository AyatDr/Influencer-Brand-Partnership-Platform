...
<head>
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <link rel="stylesheet" href="list_inf.css">
...
<body>
    <div class="side-menu">
      ...
      <a href="accueil.html"  > <img class="logo"src="images/logo.png"   alt="" > </li> </a>
         ...
         <ul> <!--liste des liens vers des pages web differents du site web -->
    ...
    <div class="container">
        ...
        <div class="content">
              <div class="content-2">
                <div class="recent">
                    <div class="title">
                        <h2>Influencers to collaborate with </h2>
                     </div>
    ...
    <?php 
           ...
           $requete = "SELECT Profile_pic, Username, Age, Media FROM influencer WHERE Username NOT IN 
             (SELECT Influencer_Login FROM partenariat WHERE Brand_Login=?)"; 
